...
public class GCSPathTest {
  ...
  public void testGetPath() {
    ...
    Assert.assertEquals(
        "gs://my-bucket/part1", "gs://" + gcsPath.getBucket() + gcsPath.getUri().getPath());
    ...
    Assert.assertEquals(
        "gs://my-bucket/part1/part2", "gs://" + gcsPath.getBucket() + gcsPath.getUri().getPath());
  ...
  public void testGetObject() {
    ...
    Assert.assertEquals(
        "avroExample.avro", GCSPath.from("gs://my-bucket/avroExample.avro").getName());
    Assert.assertEquals(
        "parquetExample.parquet", GCSPath.from("my-bucket/parquetExample.parquet").getName());
